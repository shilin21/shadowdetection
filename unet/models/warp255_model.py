...
class Warp255Model(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        Returns:
            the modified parser.
        """
        parser.set_defaults(dataset_mode='visha', lr=5e-3, batch_size=8, preprocess='resize', 
                            load_size=512, no_epoch=True, save_by_iter=True, load_iter=50000, 
                            print_freq=1, no_flip=True, display_ncols=10)
    ...
    def __init__(self, opt):
        ...
        self.netFW = networks.define_fw255(opt.num_classes, opt.backbone, opt.output_stride, opt.sync_bn, opt.freeze_bn, gpu_ids=self.gpu_ids)
