...
class EnergyModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        Returns:
            the modified parser.
        """
        parser.set_defaults(dataset_mode='sbu', lr=0.005, batch_size=8, preprocess='resize', load_size=512, no_epoch=True, normalize=True, save_by_iter=True, load_iter=50000, print_freq=1)
        ...
        parser.add_argument('--masktype', type=str, default='DepthMasks', help='type of gt masks')
