...
def computeBER_mth(GT,Pred,mth):
    ...
    for i in range(0,len(GTimlist)):
        ...
        sz = GTim.shape
        GTim = GTim>0.5
        #Predim = np.asarray(Image.open(os.path.join(Pred,im[0:-4]+'.jpg')).convert('L').resize((sz[1],sz[0]),Image.NEAREST))
...
if __name__ == "__main__":
    ...
    #print(computeBER_mth('/nfs/bigcornea/add_disk0/shilinhu/ViSha/test/labels', '/home/shilinhu/Shadow/FSDNet/ckpt/FSDNetvisha/prediction_50000/images', mth=255*np.arange(0,0.8,0.02)))
    print(computeBER_mth('/nfs/bigcornea/add_disk0/shilinhu/ViSha/test/labels', '/nfs/bigcornea/add_disk0/shilinhu/test_framework/results/off_half/test_latest_iter50000', mth=255*np.arange(0,0.8,0.02)))
    print(computeBER_mth('/nfs/bigcornea/add_disk0/shilinhu/ViSha/test/labels', '/home/shilinhu/unet/results/flowcnn255_off_half/test_latest_iter50000', mth=255*np.arange(0,0.8,0.02)))
    ...
    #print(computeBER_mth('/data/add_disk0/shilinhu/SBU/SBU-Test/ShadowMasks', '/home/shilinhu/unet/results/esd/test_latest_iter40000', mth=255*np.arange(0,0.8,0.02)))
