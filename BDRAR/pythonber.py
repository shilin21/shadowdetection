...
if __name__ == "__main__":
    ...
    print(computeBER_mth('/data/add_disk0/shilinhu/CUHKshadow/test/mask_KITTI', '/home/shilinhu/Shadow/FSDNet/ckpt/FSDNet/prediction_50000/test/shadow_KITTI', mth=255*np.arange(0,0.8,0.02)))
    print(computeBER_mth('/data/add_disk0/shilinhu/CUHKshadow/test/mask_KITTI', '/home/shilinhu/Shadow/FSDNet/ckpt/FSDNet/prediction_50000/test_w/shadow_KITTI', mth=255*np.arange(0,0.8,0.02)))
    ...
    #print(computeBER_mth('/data/add_disk0/shilinhu/SBU/SBU-Test/ShadowMasks', '/nfs/bigcornea/add_disk0/shilinhu/test_crf/bdrar/with', mth=255*np.arange(0,0.8,0.02)))
    #print(computeBER_mth('/data/add_disk0/shilinhu/SBU/SBU-Test/ShadowMasks', '/nfs/bigcornea/add_disk0/shilinhu/test_crf/bdrar/wout', mth=255*np.arange(0,0.8,0.02)))
